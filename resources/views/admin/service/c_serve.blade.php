...
@section('content')
    ...
    <form role="form" action="{{url('/kt_admin/add_serve')}}" method="post" enctype="multipart/form-data" >
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                <label for="exampleInputPassword1" > Image in home page </label>
            ...
            <div class="form-group">
                ...
                <input type="file" rows="6" class="form-control"   name="image2" id="exampleInputPassword1" placeholder="Link">

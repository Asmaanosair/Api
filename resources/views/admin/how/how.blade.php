        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title text-green">   who WE ARE Table</h3>
                    ...
                    <div class="modal modal-warning fade" id="modal-warning">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form role="form" action="{{url('/kt_admin/add_who')}}" method="post" enctype="multipart/form-data" >
            ...
            <div class="containers">
                <table class="table table-striped projects text-center">
                    ...
                    <tbody>
                    @foreach($test as $row)
                        <form method="post" action="{{url('/kt_admin/up_who/'.$row->id)}}" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <tr>
                                ...
                                <td>
                                    <textarea type="text" name="des" required="required" class="form-control" rows="7" cols="50" ><?php echo $row->des; ?></textarea>
                                    @if ($errors->has('des'))
                                        <span class="help-block">
                                            <strong>{{ $errors->first('des') }}</strong>
                                         </span>
                                ...
                                <td>
                                    <a href="{{url('/kt_admin/del_who/'.$row->id)}}" class="btn btn-danger"> Delete</a>
                                </td>

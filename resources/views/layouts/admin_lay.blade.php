        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                <div class="pull-left image">
                    <img src="{{asset('img/logo-api1_2_450x200.jpg')}}" class="img-circle" alt="User Image">
                </div>
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{url('/kt_admin/home/1')}}"><i class="fa fa-circle-o text-red"></i>  Show all   </a></li>
                    </ul>
                </li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{url('/kt_admin/who/1')}}"><i class="fa fa-circle-o text-red"></i>  Show all   </a></li>
...
{{--                <li><a href="{{url('/kt_admin/slider')}}"><i class="fa fa-circle-o text-yellow"></i> <span>Slider</span></a></li>--}}
                <li><a href="{{url('/kt_admin/about')}}"><i class="fa fa-circle-o text-yellow"></i> <span>About</span></a></li>
